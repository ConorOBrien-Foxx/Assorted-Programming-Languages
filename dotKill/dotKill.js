function modify(str){
  c=function(e){return e.charCodeAt()}
  str = str.split("\n").map(function(e){return e.split("").map(c);});
  str2 = str.map(function(e){return e.slice().reverse()}).reverse();
...
function H(x){if(x.charCodeAt()<32)return f(String.fromCharCode(x.charCodeAt()+95));if(x.charCodeAt()>126)return f(String.fromCharCode(x.charCodeAt()-95));return x;}
function dotKill(e){
  code = modify(e);
  var res = "";
